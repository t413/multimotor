...
protected:
    virtual MotorDrive** getDrives() = 0; //needed for remove() funciton
    virtual void setCount(uint8_t) = 0; //needed for remove() funciton
};
